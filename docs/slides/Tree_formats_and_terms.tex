...
\begin{itemize}
 ...
 \item Write down all the splits in ``AB|CD'' format.
 ...
 \begin{itemize}
 \item[1] A is more closely related to G than it is to C
 \item[2] (C,D,E) is sister to (A,B,F,G)
 \item[3] (C,D) is sister to (A,B,E,F,G)
 \item[4] (C,D,E) is a paraphyletic group
 \item[5] (C,D,E) is a monophyletic group
 \item[6] (A,B,C) is a monophyletic group
 \end{itemize}
\end{itemize}
\end{frame}
